...
<link rel="stylesheet" type="text/css" href="listevents.css">
</head>
<body>
...
<div class="btn-group">
	<button class="button-active" style="background-color: black" onclick="location.href='http://localhost/~kimpiabo/listevents.php';">Show All Events</button> <!--show that this button is active-->
