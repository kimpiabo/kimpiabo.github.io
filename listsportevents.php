...
<link rel="stylesheet" type="text/css" href="listsportevents.css">
</head>
<body>
...
<div class="btn-group">
	...
	<button class="button-active" style="background-color: black" onclick="location.href='http://localhost/~kimpiabo/listsportevents.php';">Show Sport Events</button>
...
<?php
	try{
	// Run a SQL query
		$sqlstr = "SELECT * FROM events WHERE category='sports'";
