...
<link rel="stylesheet" type="text/css" href="listotherevents.css">
</head>
<body>
...
<div class="btn-group">
  ...
  <button class="button-active" style="background-color: black" onclick="location.href='http://localhost/~kimpiabo/listotherevents.php';">Show Other Events</button>
  <button onclick="sortTable()" onclick="location.href='http://localhost/~kimpiabo/sortbydate.php';">Sort By Date</button>
</div>
...
<?php
	try{
	// Run a SQL query
		$sqlstr = "SELECT * FROM events WHERE category='other'";
