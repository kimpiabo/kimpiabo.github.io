...
<html >
<head>
<title>List of Sport Events</title>
<link rel="stylesheet" type="text/css" href="listcultureevents.css">
</head>
<body>
...
<div class="btn-group">
  <button class="button" onclick="location.href='http://localhost/~kimpiabo/listevents.php';">Show All Events</button>
	<button class="button" onclick="location.href='http://localhost/~kimpiabo/listsportevents.php';">Show Sport Events</button>
  <button class="button-active" style="background-color: black" onclick="location.href='http://localhost/~kimpiabo/listcultureevents.php';">Show Cultural Events</button>
...
<?php
	try{
	// Run a SQL query
		$sqlstr = "SELECT * FROM events WHERE category='culture'";
